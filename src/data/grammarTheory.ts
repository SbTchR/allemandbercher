...
export const prepositionTables = {
  ...
  dative: {
    ...
    rows: [
      ...
      ['vorbei', 'par devant', 'an der Kirche vorbei'],
    ],
  },
  mixed: {
    title: 'Prépositions mixtes : position ou déplacement ?',
    note: 'Datif si l’on décrit où se trouve quelque chose. Accusatif si l’on décrit vers où quelque chose va.',
    columns: ['Préposition', 'Position : datif', 'Déplacement : accusatif'],
    rows: [
...
export const grammarPractices = {
  ...
  'les-prepositions': {
    ...
    intro: 'Commence par la préposition. Si elle est mixte, demande-toi s’il y a déplacement ou simple position.',
    items: [
      {
        prompt: 'Quelle forme complète la phrase ?',
      ...
      },
      {
        ...
        choices: ['der', 'den', 'dem'],
        answer: 'den',
        hint: 'Le verbe legen indique un déplacement vers la table.',
        feedback: 'Préposition mixte + déplacement : accusatif, donc « auf den Tisch ».',
      },
      {
        prompt: 'Quelle forme complète la phrase ?',
        ...
        choices: ['der', 'den', 'dem'],
        answer: 'dem',
        hint: 'Le verbe liegen décrit une position.',
        feedback: 'Préposition mixte + position : datif, donc « auf dem Tisch ».',
      },
      {
        prompt: 'Quelle forme complète la phrase ?',
        ...
        choices: ['das', 'dem', 'den'],
        answer: 'das',
        hint: 'On va vers le cinéma : c’est un déplacement.',
        feedback: 'in + déplacement + neutre : accusatif, donc « in das Kino » ou « ins Kino ».',
      },
    ],
  },
  'le-genitif': {
