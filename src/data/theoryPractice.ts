...
export const theoryPracticePages: Record<string, TheoryPracticePage> = {
  ...
  'conjugaison/present': {
    ...
    cards: {
      ...
      intro: 'Retourne les cartes pour réviser les terminaisons.',
      items: [
  ...
  'conjugaison/passe-compose': {
    ...
    choices: {
      ...
      items: [
        ...
        { prompt: 'Déplacement', sentence: 'Sie ___ nach Zürich gefahren.', choices: ['hat', 'ist'], answer: 'ist', hint: 'fahren indique un déplacement.', feedback: 'fahren : sein.' },
    ...
    gaps: {
      ...
      items: [
        { prompt: 'Nous avons visité le musée.', parts: ['Wir haben das Museum ', '.'], gaps: [{ answer: 'besucht' }], hint: 'besuchen est régulier.' },
  ...
  'conjugaison/preterit': {
    ...
    cards: {
      ...
      items: [
        ...
        { front: 'sie + können', back: 'sie konnte' },
      ],
    },
    gaps: {
  ...
  'conjugaison/futur': {
    ...
    lab: {
      title: 'Deux morceaux',
      intro: 'Observe werden et l’infinitif.',
      options: [
        {
          label: 'Projet',
          sentenceHtml: 'Ich <span class="mark-verb">werde</span> nach der Schule <span class="mark-verbal-tail">reisen</span>.',
          note: 'werden est conjugué avec ich; reisen reste à la fin.',
        },
        {
          label: 'Prédiction',
          sentenceHtml: 'Wir <span class="mark-verb">werden</span> viel Deutsch <span class="mark-verbal-tail">sprechen</span>.',
          note: 'Avec wir, werden garde la forme de l’infinitif.',
        },
      ],
    },
    gaps: {
  ...
  'conjugaison/les-verbes-reflexifs': {
    ...
    level: '10H',
    lab: {
      title: 'Sujet et pronom',
      intro: 'Le pronom change avec le sujet.',
      options: [
        {
          label: 'ich',
          sentenceHtml: 'Ich ärgere <span class="case-chip case-chip-accusative">mich</span>.',
          note: 'Avec ich, le pronom réfléchi est mich.',
        },
        {
          label: 'du',
          sentenceHtml: 'Du entschuldigst <span class="case-chip case-chip-accusative">dich</span>.',
          note: 'Avec du, le pronom réfléchi est dich.',
        },
        {
          label: 'wir',
          sentenceHtml: 'Wir treffen <span class="case-chip case-chip-accusative">uns</span>.',
          note: 'Avec wir, le pronom réfléchi est uns.',
        },
      ],
    },
    choices: {
      title: 'Choisis le pronom réfléchi',
      intro: 'Regarde le sujet.',
      items: [
        { prompt: 'ich', sentence: 'Ich freue ___ auf die Ferien.', choices: ['mich', 'dich', 'sich'], answer: 'mich', hint: 'Le sujet est ich.', feedback: 'ich -> mich.' },
        { prompt: 'sie singulier', sentence: 'Lina ärgert ___.', choices: ['mich', 'sich', 'uns'], answer: 'sich', hint: 'Avec il/elle/on : sich.', feedback: 'sie -> sich.' },
        { prompt: 'ihr', sentence: 'Ihr trefft ___ im Kino.', choices: ['euch', 'uns', 'sich'], answer: 'euch', hint: 'Avec ihr : euch.', feedback: 'ihr -> euch.' },
      ],
    },
  },
